...
def parse_args():
    ...
    parser.add_argument('--train_data_path', default=base_dir + 'data_set/train/usual_train.txt', type=str, help='train data path')
    parser.add_argument('--val_data_path', default=base_dir +'data_set/eval_data/usual_eval_labeled.txt', type=str,
